package su.nightexpress.dungeons.nms.mc_1_21_10.brain.goal;
...
public class MeleeAttackGoal extends Goal {
    ...
    public boolean canContinueToUse() {
        ...
        return this.arena.getMobFaction((org.bukkit.entity.LivingEntity) target.getBukkitEntity()) != this.faction;//this.entity.isWithinHome(target.blockPosition());
    }
